...
class FixedMap extends StatelessWidget {
  ...
  const FixedMap({super.key, required this.fixedLocation});// Example location: San Francisco
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      width: size.width < 1200 ? size.width * 0.9 : 1200, // Smaller width for the map
